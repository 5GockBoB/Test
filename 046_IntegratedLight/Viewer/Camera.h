...
public:
	...
	D3DXVECTOR3 Direction(class Viewport * vp, class Perspective * perspective, D3DXVECTOR3& screenPoint);

	RECT ScreenPosition(class Viewport * vp, class Perspective * perspective, D3DXMATRIX& transform,  UINT width, UINT height);
protected:
	virtual void Move();
