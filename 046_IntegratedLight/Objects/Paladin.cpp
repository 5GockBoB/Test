	...
	, damage(50.0f), hp(100.0f)
{
	...
	collider = new CapsuleCollider(this);
	CapsuleCollider* capCol = reinterpret_cast<CapsuleCollider*>(collider);
	capCol->SetCapsule(28, 54);
	capCol->Translation(D3DXVECTOR3(0, -5, 0));

	swordCollider = new CapsuleCollider(&swordBone, 5.0f, 75.0f);
	swordCollider->Rotation(D3DXVECTOR3(87.0f, -2.0f, -15.0f));
	swordCollider->Translation(D3DXVECTOR3(-78.0f, -47.0f, -140.0f));
	swordCollider->SetGizmoRender(false);
