...
public:
	...
	void SetShader(string file, string vsName = "VS", string psName = "PS");
	...
	float* GetIntensity() { return &buffer->Data.Intensity; }
	void SetIntensity(float val) { buffer->Data.Intensity = val; }
