...
void Sky::Update()
{
	...
	if (realTime)
	{
		int minutos = Time::Get()->Running() * 60.0f;
...
void Sky::PreRender()
{
	...
	cloudBuffer->Data.SunColor = GetSunColor(-theta, 2);
...
void Sky::Render()
{
	values->Perspective->SetZf(100000.0f);
...
void Sky::GeneratePermTex()
{
	...
	permTex = new Texture(Textures + L"White.png");
